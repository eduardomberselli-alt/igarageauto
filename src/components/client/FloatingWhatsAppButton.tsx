...
export function FloatingWhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed right-5 z-50 flex items-center justify-center h-14 w-14 rounded-full bg-[#25D366] text-white shadow-[0_8px_24px_-6px_rgba(37,211,102,0.6)] hover:scale-105 transition-transform animate-[wa-pulse_2.6s_ease-in-out_infinite]"
